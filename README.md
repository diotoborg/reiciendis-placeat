# @diotoborg/reiciendis-placeat

[![codecov](https://codecov.io/gh/SalmonMode/@diotoborg/reiciendis-placeat/branch/main/graph/badge.svg?token=E28MMT0TC6)](https://codecov.io/gh/SalmonMode/@diotoborg/reiciendis-placeat)
[![Build](https://github.com/diotoborg/reiciendis-placeat/actions/workflows/npm-publish.yml/badge.svg)](https://github.com/diotoborg/reiciendis-placeat/actions/workflows/npm-publish.yml)
[![Package status](https://img.shields.io/npm/v/@diotoborg/reiciendis-placeat.svg)](https://www.npmjs.com/package/@diotoborg/reiciendis-placeat)
[![License](https://img.shields.io/npm/l/@diotoborg/reiciendis-placeat.svg)](https://opensource.org/licenses/MIT)
...
```bash
npm install @diotoborg/reiciendis-placeat
```
...
```typescript
import { assertIsString } from "@diotoborg/reiciendis-placeat";
...
```typescript
import { StringAssertionError } from "@diotoborg/reiciendis-placeat";
```
...
```typescript
import { isString } from "@diotoborg/reiciendis-placeat";
